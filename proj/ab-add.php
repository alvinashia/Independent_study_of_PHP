                ...
                <div class="card-body">
                    ...
                    <form name="form1" onsubmit="sendData();return false;" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <!-- required的意思是必填 -->
                            <!-- 原本bootstrap裡面並沒有name的屬性，要自己記得加上 -->
                        ...
                        <div class="mb-3">
                            ...
                            <!-- pattern是指輸入格式要符合後面所寫 09後面有8位數 -->
                            <div class="form-text red"></div>
                        </div>
                        <div class="mb-3">
                            <label for="birthday" class="form-label">birthday</label>
                            <input type="date" class="form-control" id="birthday" name="birthday">
                            <!-- type="date" 是用戶可以直接點的月曆，不同的瀏覽器樣式不同，就帶入輸入的値 -->
...
<script>
    ...
    // 下面的廻圈也可以這樣寫 const filedTexts = [name_f, email_f, mobile_f];等於自動去去這邊參照得到的値
    const fieldTexts = [];
    for (let f of fields) {
